 ...
 * <code>taskmanagerservicebuilder.service.impl.TaskLocalServiceImpl</code> and
...
public class TaskLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>taskmanagerservicebuilder.service.impl.TaskLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static taskmanagerservicebuilder.model.Task addTask(
	 ...
	 * @return the new task
	 */
	public static taskmanagerservicebuilder.model.Task createTask(long taskId) {
		return getService().createTask(taskId);
	}

	public static taskmanagerservicebuilder.model.Task createTask(
		String title, String text, long userId) {

		return getService().createTask(title, text, userId);
	}
	 ...
	 */
	public static taskmanagerservicebuilder.model.Task deleteTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException,
	 ...
	 * @return the task that was removed
	 */
	public static taskmanagerservicebuilder.model.Task deleteTask(
		taskmanagerservicebuilder.model.Task task) {

		return getService().deleteTask(task);
	}

	public static taskmanagerservicebuilder.model.Task doTask(long taskId)
		throws taskmanagerservicebuilder.exception.NoSuchTaskException {

		return getService().doTask(taskId);
	}
	...
	public static taskmanagerservicebuilder.model.Task editTask(
			long taskId, String title, String text, Boolean done)
		throws taskmanagerservicebuilder.exception.NoSuchTaskException {

		return getService().editTask(taskId, title, text, done);
	}

	public static taskmanagerservicebuilder.model.Task fetchTask(long taskId) {
	 ...
	 * @throws PortalException if a task with the primary key could not be found
	 */
	public static taskmanagerservicebuilder.model.Task getTask(long taskId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<taskmanagerservicebuilder.model.Task> getTasks(
		int start, int end) {
	...
	public static java.util.List<taskmanagerservicebuilder.model.Task>
		getUserTasks(long userId) {

		return getService().getUserTasks(userId);
	}

	public static taskmanagerservicebuilder.model.Task undoTask(long taskId)
		throws taskmanagerservicebuilder.exception.NoSuchTaskException {

		return getService().undoTask(taskId);
	}
	 ...
	 */
	public static taskmanagerservicebuilder.model.Task updateTask(
		taskmanagerservicebuilder.model.Task task) {
